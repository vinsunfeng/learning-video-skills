...
- `scripts/validate.py` **双向有分辨力**：未填充模板 11 个错误 + 1 个提醒
  （2026-09-08 实测；「缺 transcript.md」按提醒计，旧记录「12 个错误」是判据更新前的数字）；
  合格笔记 0 错 0 提醒
...
- cangjie-skill v2.5.0 六阶段流水线在本机对全新 transcript 一次跑通到编译发布。
  **三重验证是真门**：21 条技能候选只放行 4（19%），全片最佳技法（六宫格故事板提示词）
  因 n=1 被严格执行淘汰——好内容 ≠ 通过验证。记录：`docs/experiments/cangjie-stage4-2026-09-08.md`
